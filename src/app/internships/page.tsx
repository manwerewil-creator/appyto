...
// filtered to early-career roles. The board itself is the standard job board
// (apply by email with the user's profile & CV).
export default function InternshipsPage() {
  ...
  // ── The internship-filtered job board ───────────────────────────────────────
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
